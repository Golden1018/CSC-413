...
public class HomePage extends JFrame implements ActionListener {
    ...
    HomePage() {
        ...
        jbAdd.addActionListener(e -> {
            ...
            EmployeeDAO employeeDAO = new EmployeeDAOConcrete();
            EmployeeController controller = new EmployeeController(employeeFrame, employeeDAO);
    ...
    // This main method is not needed, unless you want to run this class by itself
    // from your IDE to validate its look'n feel
    // This frame(window) will be called as a result of an action(click, select etc)
    // from another widget on on another winhow during the GUI workflow
